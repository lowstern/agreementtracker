    ...
    <>
      <nav className={showNav ? 'show' : ''}>
        <div className="nav-container">
          <div className="logo">InvestDirectory</div>
      ...
      {showPersona && (
        <section className="persona-selector fade-in" id="persona-selector">
          <div className="persona-container">
            <div className="persona-logo">InvestDirectory</div>
      ...
      <section className="hero">
        <div className="hero-container">
          ...
          <p className="description">As asset managers expand customized, retail-facing offerings, InvestDirectory enables secure, permissioned access to contract terms—without duplicating agreements, processes, or controls.</p>
      ...
      <section className="section">
        <div className="section-container">
          ...
          <div className="market-quote">
            ...
            <p>Most firms still rely on PDFs, inboxes, and disconnected systems to manage agreements. InvestDirectory provides a living contract layer—allowing approved terms to be surfaced instantly while remaining anchored to the firm's authoritative contract record managed in Millie.</p>
      ...
      <section className="section">
        <div className="section-container">
          <h2>Why <span className="accent">InvestDirectory</span></h2>
      ...
      <section className="section" style={{background: '#f8fafc'}} id="platform">
        <div className="section-container">
          ...
          <div className="how-it-fits">
            ...
            <p className="intro">InvestDirectory is a dedicated access layer built on top of Millie, the enterprise contract platform already used by asset managers to govern agreements firmwide.</p>
            <p className="list-title">This allows InvestDirectory to:</p>
            <ul>
      ...
      <footer>
        <div className="footer-container">
          <div className="footer-text">© 2026 InvestDirectory · Contract Intelligence Platform</div>
